...
(async () => {
    ...
    if (userdata.data) {
        ...
        user = `<dc data-bs-toggle="tooltip" data-bs-placement="left" title="" data-bs-original-title="${userdata.username}"> <img id="user_avatar" src="https://cdn.discordapp.com/avatars/${userdata.data.id}/${userdata.data.avatar}.png" title="${userdata.data.username}" width="50" height="50" alien="rig"><b id="Nname" style="color: #6f6eeb;"></b> </dc>`;
